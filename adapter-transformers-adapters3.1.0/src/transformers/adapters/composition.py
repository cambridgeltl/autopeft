...
class Aggregate(AdapterCompositionBlock):
    def __init__(self, *aggregation_layers: List[Union[AdapterCompositionBlock, str]]):
        super().__init__(*aggregation_layers)
...
ALLOWED_NESTINGS = {
    ...
    Aggregate: [str, Fuse, Split, Parallel, BatchSplit],
}
